    ...
    internal sealed class Configuration : DbMigrationsConfiguration<ConstructIT.DAL.ConstructITDBContext>
    {
        ...
        {/*
            ...
            context.Prioriteti.AddOrUpdate(
                new Prioritet { PrioritetNaziv = "Blokirajući", PrioritetTezina = 1.0f },
                new Prioritet { PrioritetNaziv = "Kritični", PrioritetTezina = 0.8f },
            ...
            context.Zadaci.AddOrUpdate(
                new Zadatak { ZadatakNaziv = "Raščišćavanje terena", ProjekatID = 1, ZadatakDatumPocetka = DateTime.Now.AddDays(-8).Date, ZadatakDatumZavrsetka = DateTime.Today.AddDays(-6).Date, PrioritetID = 4, StatusID = 3, ZadatakOpis = " Ex eos harum nullam instructior. Iuvaret iracundia instructior te ius, summo placerat moderatius eam id. Viris sapientem vulputate vis et. Postea essent quaestio cum ei, viderer fabellas urbanitas at usu, dicant persius per id. Idque integre electram id est, pro lorem aperiri periculis et." },
            ...
            context.Struke.AddOrUpdate(
                ...
                new Struka { StrukaNaziv = "Ispomoć" },
            ...
            context.TipoviMasina.AddOrUpdate(
                ...
                new TipMasine { TipMasineNaziv = "Rovokopač" },
