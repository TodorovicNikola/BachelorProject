...
namespace ConstructIT.Controllers
{
    public class ProizvodniRadnikController : Controller
    {
        ...
        public async Task<ActionResult> Create([Bind(Include = "ProizvodniRadnikID,ProizRadJMBG,ProizRadIme,ProizRadPrezime,ProizRadEMail,ProizRadAdresa,ProizRadTelKucni,ProizRadTelMob,StrukaID")] ProizvodniRadnik proizvodniRadnik)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<ActionResult> Edit([Bind(Include = "ProizvodniRadnikID,ProizRadJMBG,ProizRadIme,ProizRadPrezime,ProizRadEMail,ProizRadAdresa,ProizRadTelKucni,ProizRadTelMob,StrukaID")] ProizvodniRadnik proizvodniRadnik)
        {
            if (ModelState.IsValid)
            {
